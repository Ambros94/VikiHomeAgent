...
L'informazione viene reperita dal braccio, seguendo l'architettura REST, attraverso una chiamata all'indirizzo GET \textit{"/metadata"}, all'indirizzo del braccio. Essa ritorna una struttura dati JSON che descrive le capacità il sistema, con un formalismo documentato nel capitolo 5(?).
...
\textit{"Descrizione di cosa è e delle librerie utilizzate"}
